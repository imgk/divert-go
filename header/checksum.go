...
func PseudoHeaderChecksum(protocol uint, srcAddr []byte, dstAddr []byte, totalLen uint16) uint16 {
...
func checksumUpdate2ByteAlignedAddress(xsum uint16, old, new []byte) uint16 {
	const uint16Bytes = 2
